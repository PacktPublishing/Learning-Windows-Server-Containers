...
function Build(){
	...
	dotnet.exe publish --framework netcoreapp1.0 --configuration $Configuration --output /learningwsc/chapter7/musicstore-redis/begin/musicstore/publishoutput --no-build
